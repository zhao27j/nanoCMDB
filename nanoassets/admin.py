...
from .resources import ManufacturerResource, ModelTypeResource,  InstanceResource, disposalRequestResource, branchSiteResource, configClassResource, ConfigResource
